...
<html lang="en">
  <head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/ecommerce/owl.carousel.css">
    <link rel="stylesheet" href="css/ecommerce/stylesalepage.css">
    <link rel="stylesheet" href="css/ecommerce/responsivesalepage.css">
  ...
  <body>
   ...
   <!-- 
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="img/ecommerce/product-thumb-1.jpg" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="img/ecommerce/product-thumb-2.jpg" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="img/ecommerce/product-thumb-3.jpg" alt="" class="product-thumb"></a>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="#" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="img/ecommerce/product-thumb-4.jpg" alt="" class="product-thumb"></a>
    ...
    <!-- jQuery sticky menu -->
    <script src="js/ecommerce/owl.carousel.min.js"></script>
    <script src="js/ecommerce/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="js/ecommerce/jquery.easing.1.3.min.js"></script>
